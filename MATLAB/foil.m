...
%    screen output
  ...
  disp ( sprintf ( '\n%s%5.3f%s', 'Results for alpha = ', alpha(nalpha), ' degrees' ) )
...
%    save data for this alpha
  fname = ['Data/' section '/' caseref '_' num2str(alpha(nalpha)) '.mat'];
...
save ( fname, 'xs', 'ys', 'alpha', 'clswp', 'cdswp', 'lovdswp','section')